...
- 数字を変換対象にする
  - 数字(0～9)をキリズマのデータとして変換するかどうかを指定します。通常は無視します。
  - ここにチェックを入れた結果を使う場合、実際のキーモード名に表示されたキーを使用するようにしてください。
- かなモードで英字も使用する(47k/51k拡張)
  - かなモード限定で、英字を使用する場合はチェックを入れます。通常は英字を無視します。
  - ここにチェックを入れた結果を使う場合、実際のキーモード名に表示されたキーを使用するようにしてください。
